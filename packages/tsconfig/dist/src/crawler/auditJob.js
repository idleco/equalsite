...
async function callbackWithArtifacts({ crawlId, callbackUrl, zippedArtifactsPath, }) {
    const form = new FormData();
    form.append('crawlId', crawlId);
    form.append('artifact', new Blob([fs.readFileSync(zippedArtifactsPath)]), `${crawlId}.zip`);
